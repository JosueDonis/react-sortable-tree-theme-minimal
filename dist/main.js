...
*/
    ...
    function(module, exports, __webpack_require__) {
        ...
        var _nodeContentRenderer = __webpack_require__(5), _nodeContentRenderer2 = _interopRequireDefault(_nodeContentRenderer), _treeNodeRenderer = __webpack_require__(15), _treeNodeRenderer2 = _interopRequireDefault(_treeNodeRenderer);
    ...
    function(module, exports, __webpack_require__) {
        ...
        }(), _react = __webpack_require__(0), _react2 = _interopRequireDefault(_react), _propTypes = __webpack_require__(1), _propTypes2 = _interopRequireDefault(_propTypes), _nodeContentRenderer = __webpack_require__(6), _nodeContentRenderer2 = _interopRequireDefault(_nodeContentRenderer), _Add = __webpack_require__(9), _IconButton = (_interopRequireDefault(_Add), 
        __webpack_require__(10)), _ExpandMore = (_interopRequireDefault(_IconButton), __webpack_require__(11)), _ExpandMore2 = _interopRequireDefault(_ExpandMore), _NavigateNext = __webpack_require__(12), _NavigateNext2 = _interopRequireDefault(_NavigateNext), _TextField = __webpack_require__(13), _InputBase = (_interopRequireDefault(_TextField), 
        __webpack_require__(14)), MinimalThemeNodeContentRenderer = (_interopRequireDefault(_InputBase), 
        function(_Component) {
            function MinimalThemeNodeContentRenderer(props) {
                _classCallCheck(this, MinimalThemeNodeContentRenderer);
                var _this = _possibleConstructorReturn(this, (MinimalThemeNodeContentRenderer.__proto__ || Object.getPrototypeOf(MinimalThemeNodeContentRenderer)).call(this, props));
                return _this.state = {
                    text: props.title
                }, _this;
            }
            return _inherits(MinimalThemeNodeContentRenderer, _Component), _createClass(MinimalThemeNodeContentRenderer, [ {
                ...
                value: function() {
                    ...
                    }, otherProps), toggleChildrenVisibility && node.children && (node.children.length > 0 || "function" == typeof node.children) && _react2.default.createElement("div", null, node.expanded ? _react2.default.createElement(_ExpandMore2.default, {
                        className: _nodeContentRenderer2.default.expandButton,
                        onClick: function() {
                    ...
                    }) : _react2.default.createElement(_NavigateNext2.default, {
                        className: _nodeContentRenderer2.default.collapseButton,
                        onClick: function() {
                            return toggleChildrenVisibility({
                                node: node,
                                path: path,
 ...
 */
    ...
    function(module, exports, __webpack_require__) {
        ...
        }(), _react = __webpack_require__(0), _react2 = _interopRequireDefault(_react), _propTypes = __webpack_require__(1), _propTypes2 = _interopRequireDefault(_propTypes), _treeNodeRenderer = __webpack_require__(16), _treeNodeRenderer2 = _interopRequireDefault(_treeNodeRenderer), MinimalThemeTreeNodeRenderer = function(_Component) {
